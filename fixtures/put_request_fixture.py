...
class PutRequestFixture:
    """
    Python SLIM Decision Table fixture for HTTP PUT requests.
    """
    ...
    def execute(self) -> bool:
        try:
            ...
            response = requests.put(self._url, data=self._body_json, headers=headers, timeout=15)
            ...
            print(f"[PUT] Exception [{self._url}]: {str(e)}")
            return False
