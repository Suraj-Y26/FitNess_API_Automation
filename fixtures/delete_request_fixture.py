...
class DeleteRequestFixture:
    """
    Python SLIM Decision Table fixture for HTTP DELETE requests.
    """
    ...
    def execute(self) -> bool:
        try:
            ...
            response = requests.delete(self._url, headers=headers, timeout=15)
            ...
            print(f"[DELETE] Exception [{self._url}]: {str(e)}")
            return False
